...
<tbody>
  ...
  <tr>
    <td class="tg-oczp" onClick="location.href='#volumeid-구조';" style="cursor:pointer;color:#blue;">VolumeID (variable)</td>
  ...
  <tr>
    <td class="tg-oczp" onClick="location.href='#commonnetworkrelativelink-구조';" style="cursor:pointer;color:#blue;" >CommonNetworkRelativeLink (variable)</td>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0usf" onClick="window.open('https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-shllink/23bb5877-e3dd-4799-9f50-79f05f938537','','');" style="cursor:pointer;color:#blue;">네트워크 공급자의 유형</td>
  </tr>
  <tr>
...
VolumeID 필드 위치: 0x1C<br> 
LocalBasePath 필드 위치: 0x2D<br>
CommonNetworkRelativeLink 필드 위치: 0x38<br>
CommonPathSuffix 필드 위치: 0x5D<br>

VolumeID 구조의 크기: 0x11 = 17<br>
DriveType: 0x00000003 – DRIVE_FIXED (SSD 또는 HDD)<br>
DriveSerialNumber: 0xC6 F9 D2 29<br>
볼륨 레이블은 없다.<br>
...
LocalBasePath + CommonPathSuffix: C:\Users\HO\Desktop\APP\Calculator.exe<br>


[안녕](#commonnetworkrelativelink-구조)