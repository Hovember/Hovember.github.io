...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-oczp" onClick="location.href='#VolumID 구조'" style="cursor:pointer;">VolumeID 필드 위치</td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="tg-oczp">VolumeID (variable)</td>
  ...
  <tr>
    <td class="tg-oczp">CommonNetworkRelativeLink (variable)   </td>
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0usf" onClick="window.open('https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-shllink/23bb5877-e3dd-4799-9f50-79f05f938537','','');" style="cursor:pointer;">네트워크 공급자의 유형</td>
  </tr>
  <tr>
